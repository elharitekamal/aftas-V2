...
public class competitionConfig {
    ...
    CommandLineRunner commandLineRunnerCompetition(CompetitionRepository competitionRepository) {
        return args -> {
            Competition c1 = new Competition("hoc-19-12-23", LocalDate.of(2024,2,26), LocalTime.of(10, 0),
                    LocalTime.of(12, 0), 50, "hoceima", 1000.0);
            Competition c2 = new Competition("jad-19-12-23", LocalDate.of(2024,2,26), LocalTime.of(14, 0),
